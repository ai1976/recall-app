...
- Onboarding follow-up: added a "Check what is already there to browse" step to Guide's first-day flow, and an equivalent bullet to Help's "Your First Steps", so a new student learns they can Browse → Practice → Add to My Cards from pre-loaded professor/official-body content before creating anything of their own — not just after.
