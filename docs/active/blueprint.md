...
**Educators.jsx** (`/educators`) — Phase 5 Sprint 5, ✅ deployed 2026-07-01
- **Reads:** None (static value-proposition content)
- **Writes:** `submit_institute_inquiry()` RPC only (SECURITY DEFINER, anon-callable) — zero direct `.from()`, per the unauthenticated-page rule
