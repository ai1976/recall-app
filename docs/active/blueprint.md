...
| `unfeature_content(p_content_type, p_content_id)` | Admin/super_admin removes live content from the landing; full removal — nulls all four nomination/approval fields (leaves landing + pending queue). **⏳ SQL authored — not yet deployed (`docs/database/phase5/11`)** | AdminDashboard.jsx |
