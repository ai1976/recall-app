...
- Consume the additive `--rv-*` token layer (`src/index.css`) + self-hosted Plex/Literata faces. Isolated: the dev-only `/__design` QA route is their only consumer this sprint. Chrome migration = 6.2, dashboards = 6.3, study loop = 6.4.
