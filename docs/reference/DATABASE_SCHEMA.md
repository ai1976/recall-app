...
**Scope C (subject-wide Practice All) shipped 25/09/2026 — see §2.4E's signature-change note.** **Not yet built (Scope D, tracked in `docs/active/now.md`):** the My Study page redesign (Subject/Topic grouping, New/Active/Paused counts, Mastered/Removed moved to a History tab).
