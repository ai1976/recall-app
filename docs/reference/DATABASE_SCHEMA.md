...
**Not yet built (Scope C/D, tracked in `docs/active/now.md`):** subject-wide Practice All (`get_practice_cards` is still single-deck only); the My Study page redesign (Subject/Topic grouping, New/Active/Paused counts, Mastered/Removed moved to a History tab).
