                        ...
                        <div key={note.id} className="flex items-start justify-between p-3 border rounded-lg hover:bg-gray-50">
                          <div className="flex-1 min-w-0">
                            ...
                            <a
                              ...
                              className="font-medium text-amber-700 hover:text-[#1e1b4b] hover:underline text-sm flex items-center gap-1 truncate"
                            >
                              {note.title}
                          ...
                          <div className="flex items-start justify-between p-3 hover:bg-gray-50">
                            ...
                            <div className="flex items-center gap-2 ml-3 shrink-0">
                              <button
                                ...
                                className="text-xs text-amber-600 hover:text-[#1e1b4b] flex items-center gap-1 px-2 py-1 rounded border border-amber-200 hover:bg-amber-50 transition-colors"
                              >
              ...
              <CardContent className="space-y-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full text-sm border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-amber-400 bg-white"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-sm border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-amber-400"
                  />
                </div>
                <div>
...
function RoleBadge({ role }) {
  const cls =
    role === 'super_admin' ? 'bg-amber-100 text-[#1e1b4b]' :
    role === 'admin'       ? 'bg-red-100 text-red-800'       :
    role === 'professor'   ? 'bg-amber-100 text-[#1e1b4b]'     :
