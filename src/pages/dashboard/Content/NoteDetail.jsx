...
export default function NoteDetail() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-[calc(3.5rem+env(safe-area-inset-bottom))] md:pb-0">
      {/* Header */}
      {/* md:top-12 clears the NavUtilityStrip's fixed 48px strip (Sprint
          8.8.3a, D-39) — mobile keeps top-0, unaffected since the strip
          doesn't exist below md. */}
      <header className="bg-white border-b border-gray-200 sticky top-0 md:top-12 z-10">
